...
hm3 = HeatMap(dat1,min_opacity=0.02,max_opacity=0.8,gradient={0.0: 'white',  1.0: 'red'},radius = 25).add_to(m3)
hm4 = HeatMap(dat0,min_opacity=0.02,max_opacity=0.8,gradient={0.0: 'blue',  1.0: 'white'},radius = 25).add_to(m3)

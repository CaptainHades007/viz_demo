...
fig.update_traces(marker=dict(color=data['class'].map({'BPL': 'lightblue', 'APL': 'red'}),size=8))
...
hm = HeatMap(dat,min_opacity=0.2,max_opacity=0.8,gradient={0.0: 'blue',  1.0: 'red'},radius = 20).add_to(m1)
# st_folium(m1)
